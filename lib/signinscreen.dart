...
import 'package:hemocare/reset_password.dart';
import 'package:hemocare/signup_screen.dart';
import 'package:hemocare/social_icon.dart';
import 'package:hemocare/utils/constants.dart';
          ...
          child: Padding(
            ...
            child: Column(
              children: <Widget>[
                ...
                Center(
                    child: Image.asset("assets/images/logo-no-background2.png", fit: BoxFit.fill,
                      height: height*0.2,
                      width: height*0.3,
                      )),
                SizedBox(
